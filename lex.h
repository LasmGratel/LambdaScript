...
enum RESERVED {
	...
	/* symbols */
	TK_TRIDOT,
	TK_NE, TK_LE, TK_GE, TK_EQ,

	/* not implemented */
	/*
	TK_BREAK,
	TK_DO, _TK_ELSE, TK_ELSEIF, TK_END, _TK_FALSE, TK_FOR, TK_FUNCTION,
	TK_GOTO, _TK_IF, TK_IN, TK_LOCAL, _TK_NIL, TK_NOT, _TK_OR, TK_REPEAT,
